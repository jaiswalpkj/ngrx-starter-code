...
import { addToBucket, removeItemFromBucket } from '../../store/actions/bucket.action';
...
export class GroceryComponent {
  ...
  constructor(private readonly store: Store<{groceries:Grocery[]}>) {
  ...
  decrement(item:Grocery){
    ...
    this.store.dispatch(removeItemFromBucket({payload}))
